import { filterData, sortData, computeStats, filterGeneration } from './dataFunctions.js';
...
selectFilter.addEventListener("change", () => {
  ...
  if (value === 'seleccionar') {
    ...
    No se encontraron Pokemones de tipo Flying, puedes seguir navegando por otros tipos! </div>
    `
